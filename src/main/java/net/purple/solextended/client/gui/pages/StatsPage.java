...
public final class StatsPage extends Page {
    public StatsPage(int foodsEaten, Rectangle frame) {
        super(frame, LocalizationHelper.localizedComponent(MODID, "gui", "food_book.stats.title"));
        ...
        UIElement foodsEatenStat = statWithIcon(
                ...
                LocalizationHelper.localizedComponent(MODID, "gui", "food_book.stats.foods_eaten").getString()
        );
