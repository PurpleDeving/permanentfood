...
public final class PlayerAttributesUIPage extends PageClone {
    ...
    public PlayerAttributesUIPage(Player player, Rectangle frame) {
        ...
        AttributeModifier modifierArmor = player.getAttributes().getInstance(Attributes.ARMOR).getModifier(resourceLocationFoodArmorBuff);
        ...
        AttributeModifier modifierArmorThoughness = player.getAttributes().getInstance(Attributes.ARMOR_TOUGHNESS).getModifier(resourceLocationFoodArmorToughnessBuff);
        ...
        UIElement ValueStat_ArmorThoughness = statTextWithIcon(
                ...
                localized("gui", "food_book.attributes.food_armor_thoughness")
        );
        ValueStat_ArmorThoughness.tooltip = localized("gui", "food_book.attributes.tooltip.food_armor_thoughness");
